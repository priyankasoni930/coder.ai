...
export default function Home() {
  ...
  return (
    <div className="mx-auto flex max-h-full min-h-screen max-w-full flex-col items-center justify-center bg-black py-2">
                      ...
                      <button
                        ...
                        onClick={async () => {
                          ...
                          navigator.clipboard.writeText(
                            `https://coder-ai-snowy.vercel.app/share/${appId}`,
                          );
                        }}
